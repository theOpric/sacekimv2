...
const queryString = 'kurumAdi telefon eposta youtube instagram facebook';
...
const Insert = (data, actionName, callback) => {
    ...
    let newData = new schemaGenelAyarlamalar({
        ...
        eposta: clientData[2],
        youtube: clientData[3],
        instagram: clientData[4],
        facebook: clientData[5],
    });
    let returnDataFormat = ['_id', 'kurumAdi', 'telefon', 'eposta', 'youtube', 'instagram', 'facebook'];
    delete data['data'];
    let json = {
...
const Update = (data, actionName, callback) => {
    ...
    let returnDataFormat = ['_id', 'kurumAdi', 'telefon', 'eposta', 'youtube', 'instagram', 'facebook'];
    let updateFieldValue = ['', clientData[0], clientData[1], clientData[2], clientData[3], clientData[4], clientData[5]];
    let json = {
        request: data,
        actionName,
        returnDataFormat,
