   ...
   },
   {
      ...
      <li> <a href="#"><i class="fa fa-cog"></i><span>İçerik Yönetimi</span></a>
         <ul>
            ...
            <li> <a href="#" class='menuAction'><i class="fa fa-file-image-o"></i><span id="menuAnasayfaSlider">Saç Ekimine Dair</span></a> </li>
            <li> <a href="#" class='menuAction'><i class="fa fa-refresh"></i><span id="menuOncesiSonrasi">Öncesi ve Sonrası</span></a> </li>
            <li> <a href="#" class='menuAction'><i class="fa fa-comments"></i><span id="menuHizmetYorumlari">Hizmet Yorumları</span></a> </li>
